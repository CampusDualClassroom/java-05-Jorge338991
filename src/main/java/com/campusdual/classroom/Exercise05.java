...
public class Exercise05 {
    ...
    public static void checkLessOrGreaterEqual(int n1, int n2) {
        if (n1 < n2) System.out.println("X es menor que Y");
    ...
    public static void checkMultiply(int n1, int n2) {
        if (n1 % n2 == 0) System.out.println("X es múltiplo de Y");
        else System.out.println("X no es múltiplo de Y");
    }
    ...
    public static void checkPositiveNegative(int num) {
        if (num > -1) System.out.println("X es positivo.");
